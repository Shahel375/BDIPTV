...
def write_to_file(playlist, output_file, include_credits=False):
    credit_text = "# All the links in this file are collected from public sources. If anyone wants to remove their source, please let us know. We respect your opinions and efforts.
        f.write("#EXTM3U\n")  
        if include_credits:
            f.write(credit_text)
